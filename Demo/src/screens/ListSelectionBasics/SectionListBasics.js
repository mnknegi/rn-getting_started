        ...
        sections={[
          {
            ...
            data: [
              ...
              {
                name: 'Tiger',
                img: require('../../../assets/animals/tiger.jpeg'),
              },
              {
                name: 'Monkey',
          ...
          },
          {
            ...
            data: [
              ...
              {
                name: 'Xman',
                img: require('../../../assets/superheros/xman.jpeg'),
              },
              {
                name: 'Ironman',
          ...
          },
          {
            ...
            data: [
              {
                name: 'Apple',
                img: require('../../../assets/fruits/apple.jpeg'),
              },
              {
                name: 'Banana',
                img: require('../../../assets/fruits/banana.jpeg'),
              },
              {
                name: 'Grapes',
                img: require('../../../assets/fruits/grapes.jpeg'),
              },
              {
                name: 'Water Melon',
